...
public class EasyJoystick : MonoBehaviour
{
    ...
    void OnEnable()
    {
        EasyTouch.On_JoystickTouchStart += On_TouchStart;
        EasyTouch.On_JoystickTouchUp += On_TouchUp;
        EasyTouch.On_JoystickTouchDown += On_TouchDown;
        EasyTouch.On_JoystickSimpleTap += On_SimpleTap;
        EasyTouch.On_JoystickDoubleTap += On_DoubleTap;
    ...
    void UpdateJoystick()
    {
        ...
        if (Application.isPlaying)
        {
            ...
            if (EasyTouch.GetTouchCount(true) == 0)
            {
                joystickIndex = -1;
                if (dynamicJoystick)
                {
        ...
        if (!useBroadcast)
        {
            switch (message)
            {
                ...
                case MessageName.On_JoystickTouchStart:
                    ...
                    {
                        EasyTouchInput.JoystickFingerIndex = joystickIndex;
                ...
                case MessageName.On_JoystickTouchUp:
                    ...
                    {
                        EasyTouchInput.JoystickFingerIndex = -1;
    ...
    public void ComputeJoystickAnchor()
    {
        ComputeJoystickAnchor(joyAnchor);
    }
