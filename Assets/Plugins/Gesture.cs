...
public class Gesture
{
    ...
    /// <summary>
    /// The is hover On NGUI. Added by qiulei, [2014-11-6]
    /// </summary>
    public bool isHoverOnNGUI;
    ...
    /// </summary>
    /// <returns></returns>
    public Vector2 deltaPositionPerFrame
    {
        get
        {
            //使用unity remote时，此值是零
            if (deltaTime == 0)
            {
                return deltaPosition;
            }

            return deltaPosition * deltaTimeFrame / deltaTime;
        }
    }
    ...
    /// </summary>
    /// <returns></returns>
    public Vector2 swipeVectorPerFrame
    {
        get
        {
            if (deltaTime == 0)
            ...
            return swipeVector * deltaTimeFrame / deltaTime;
        }
    }
}
